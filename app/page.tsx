...
export default function LandingPage() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-zinc-900 text-zinc-100 flex flex-col relative overflow-hidden">
      ...
      <main className="flex-grow flex flex-col justify-center items-center text-center p-6 z-10 pt-24 pb-16">
        <FadeIn duration={0.8}>
          ...
          >
            <h1 className="text-4xl md:text-7xl font-bold mb-6 leading-tight">
              Support Creators with <GlitchText text="Crypto" glitchIntensity="medium" className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-500" />
            </h1>
          </motion.div>
        </FadeIn>
        ...
        <StaggerChildren className="mt-8 grid gap-8 md:grid-cols-3 max-w-4xl w-full">
          <FloatingCard delay={0} amplitude={8} duration={5}>
            <Enhanced3DCard className="p-8 cursor-default h-full" glowColor="rgba(99, 102, 241, 0.4)">
          ...
          <FloatingCard delay={0.2} amplitude={10} duration={5.5}>
            <Enhanced3DCard className="p-8 cursor-default h-full" glowColor="rgba(124, 58, 237, 0.4)">
              <div className="bg-indigo-500/10 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
          ...
          <FloatingCard delay={0.4} amplitude={7} duration={4.5}>
            <Enhanced3DCard className="p-8 cursor-default h-full" glowColor="rgba(139, 92, 246, 0.4)">
              <div className="bg-indigo-500/10 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
        ...
        <FadeIn className="mt-24 w-full max-w-4xl" threshold={0.1}>
          <div className="relative">
            ...
            <div className="relative bg-zinc-800/80 backdrop-blur-sm p-8 rounded-xl">
              ...
              />
              <p className="text-right text-indigo-400 font-medium">— Alex Rivera, Digital Artist</p>
            </div>
          </div>
        </FadeIn>
      </main>
