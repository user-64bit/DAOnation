...
export default function UserCard({
  ...
  return (
    <Card className="w-full max-w-md bg-gradient-to-br from-zinc-900 via-zinc-800 to-indigo-900 text-zinc-100 overflow-hidden relative">
      ...
      <CardContent className="relative flex justify-between z-10 p-6">
        ...
        <div className="flex justify-between items-center">
          <div className="text-center">
            <p className="text-xs text-zinc-400 mb-1 hover:underline">
